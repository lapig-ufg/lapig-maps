...
/** api: constructor
 *  .. class:: LapigWMSGetFeatureInfo(config)
 *
 *    This plugins provides an action which, when active, will issue a
 *    GetFeatureInfo request to the WMS of all layers on the map. The output
 *    will be displayed in a popup.
 */   
gxp.plugins.LapigWMSGetFeatureInfo = Ext.extend(gxp.plugins.Tool, {
     ...
     */
     ...
     constructor: function(config) {
        ...
        gxp.plugins.LapigWMSGetFeatureInfo.superclass.constructor.apply(this, arguments);
    },
            ...
            for (var i=0,ii=features.length; i<ii; ++i) {
                ...
                for (var key in feature.attributes) {
                  if(this.attributes[key]) {
                    ...
                    feature.attributes[alias] = feature.attributes[key];
...
Ext.preg(gxp.plugins.LapigWMSGetFeatureInfo.prototype.ptype, gxp.plugins.LapigWMSGetFeatureInfo);
