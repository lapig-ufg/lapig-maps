...
gxp.plugins.LapigRasterSeries = Ext.extend(gxp.plugins.Tool, {
    ...
    getWestCmp: function() {
        ...
        var rasterSeriesForm = {
            ...
            border: false,
            region: 'west',
            id: 'lapig-raster-series-west-info',
            collapsible: false,
            layout:'fit',
            width: 170,
            items: {
                  ...
                  items:[
                      ...
                      , {
                          ...
                          id: "lapig-raster-series-fds-info",
                          disabled: true,
                          defaults: {
                            xtype: 'label',
                          ...
                          items: [
                            {
                              id: "lapig-raster-series-lbl-category",
                              text: "Categoria: -",
                            }, {
                              id: "lapig-raster-series-lbl-local",
                              text: "Localização: -"
                            }
                          ]
                        }
    ...
    getCenterCmp: function (){
          ...
          listeners: {
            click: function(node, e ) {
              ...
              if(node.leaf) {
                ...
                var formTimeSeries = Ext.getCmp('form-time-series');
          ...
          items:[
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  id: 'form-time-series',
                  waitMsgTarget: 'form-time-series',
                  disabled: true,
                      ...
                      buttons: [{
                        ...
                        listeners: {
                          click: function(evt) {
                              ...
                              },
                              {
                                ...
                                listeners: {
                                  click: function(evt) {
                                    ...
                                    var lblCategory = Ext.getCmp("lapig-raster-series-lbl-category");
                                    var lblLocal = Ext.getCmp("lapig-raster-series-lbl-local");
                                    var westInfo = Ext.getCmp('lapig-raster-series-west-info');
                                    var chartCenter = Ext.getCmp('lapig-coordinates-center-chart');
                                    ...
                                    var url = 'time-series/' + timeSeriesData._id + '/values'

                                    var msgText = "Isto pode levar alguns minutinhos, relaxe e tome um café... ";

                                    var loadMask = new Ext.LoadMask(Ext.getDom('lapig-raster-series-chart-panel'), {
                                        msg: msgText
                                    });
                                    loadMask.show();
                            ...
                            lapigCoordinatesTool.handler(null, null, buttons);

                            /*var nameTimeSeries = Ext.getCmp('name-time-series');
                            nameTimeSeries.setText(timeSeriesData.name)*/
                          },
                        },
                      }],
                    },
                  ...
                  listeners: {
                    'actioncomplete': function(basicFormLayer, actionLayer) {
                      ...
                      var fieldSource = Ext.getCmp('field-time-series-source');
        ...
        var filterChart = function(combo, record, index) {
